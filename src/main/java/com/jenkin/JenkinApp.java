...
import com.jenkin.config.ApplicationProperties;
import com.jenkin.config.DefaultProfileUtil;
...
public class JenkinApp {

    private static final Logger log = LoggerFactory.getLogger(JenkinApp.class);

    private final Environment env;

    public JenkinApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JenkinApp.class);
